...
class index extends Component{
    constructor(props){
        super(props);
        this.state = {
            searchSty:{paddingLeft:'15px',paddingRight:'15px'},
    ...
    render (){
        return <div style={this.state.pagestyle} ref="scroller">
            <SearchBar style={this.state.searchSty} defaultValue={this.state.defaultValue} placeholder="搜你想搜" cancelText="取消"
                       onCancel={this.handlerCancel} onChange={this.handler_change}>
            </SearchBar>
            <Swiper spaceBetween={5} loop={true} slideWidth={0.9} centerMode={true} autoplay={true}>
